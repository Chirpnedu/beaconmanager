...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		...
		<!--stylesheet include-->
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/camera.css">
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/owl.carousel.css">
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/owl.transitions.css">
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/jquery.custom-scrollbar.css">
		<link rel="stylesheet" type="text/css" media="all" href="css_extra/style.css">
		<!--font include-->
		<link href="css_extra/font-awesome.min.css" rel="stylesheet">
